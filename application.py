...
# @app.route('/brand')
# def index():
#     return render_template('form.html', brands=data.keys())
...
# def predict():    # Here you would use your model to predict the price
#     # For demonstration, we'll return a dummy price
#     predicted_price = 500000
#     return json.dumps({'price': predicted_price})
